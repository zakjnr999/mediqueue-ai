...
/**
 * Factory function to create PATCH /patients/{patientId}/status Lambda handler.
 * 
  ...
  return async function handleRequest(event, context) {
    ...
    try {
      ...
      const deps = {
        ...
        updatePatientStatusFn: dependencies.updatePatientStatusFn || (dependencies.getDocClientFn ? (async (id, params) => {
